...
export const DEFAULT_DESCRIPTION =
  "OpenAI-compatible inference API routed across DePIN networks (io.net and Akash). Wallet auth, USDC funding, and x402 pay-per-call for developers and autonomous agents.";
